...
/**
* closeSession: Gestiona el cerrado y borrado de la cooki de session del navegador
*/
...
/**
* get: Devuelve el valor de una variable de sesión o en su defecto el valor que quiera el usuario si no existe
*
* @param $index
* @param null $else
* @return null
...
/**
* del: Elimina una variable de $_SESSION
*
* @param $index
*/
