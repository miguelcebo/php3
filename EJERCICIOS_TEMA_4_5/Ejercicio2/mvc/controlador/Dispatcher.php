...
// clase que permite registrar y ejecutar los métodos del modelo (y sus clases) que atienden los eventos que 
//se producen a través de la vista
...
// Comprobamos si el método ($callback[1]) existe en la clase ($callback[0]) antes de registrarlo
